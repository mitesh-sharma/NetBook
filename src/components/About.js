const About = () => {
  return (
    <div className="bg-dark p-5 rounded-5 text-white">
      ...
      <p>This Project is built by Mitesh Sharma, a computer science undergrad at VIT Bhopal. It is a simple and minimalistic project and will be updated with new features in the future.</p>
